...
function showProducts() {
    data.map(item => {
        cards.innerHTML += `
             <div onclick="openPizza('${item.id}', '${item.img}', '${item.name}', '${item.price}')" class="card cursor-pointer mb-[20px] px-2">
                    <div class="mb-[10px]">
        ...
        <div onclick="dayan(event)" class=" bg-white w-[400px] h-auto">
                 ...
                 <div class="w-[320px] m-auto h-auto">
                  ...
                  <div class="mt-4 mb-2 rounded-md text-white cursor-pointer bg-[#0f9675]">
                      <button onclick="showPizza('${id}','${name}', '${price}')" class="px-5 py-2 ">Sebete at</button>
                  </div>
...
function openPopup() {
    ...
    flag = !flag
    bgBlur.innerHTML =  `
        <div onclick="dayan(event)" class="pop-up w-full h- md:h-[200px] md:min-h-[200px] md:w-[650px] px-[20px] py-[10px]  relative bg-white">
...
function addBasket() {
    const basketContent = bgBlur.querySelector('.basket-content');
    const basketCount = bgBlur.querySelector('.basket-count');
    const totalPriceElement = bgBlur.querySelector('.total-price');
    ...
    basketCount.innerHTML = `Sebetinizdeki mehsullarin sayi: ${totalCount}`
    totalPriceElement.innerHTML = `Umumi mebleg: ${totalPrice} m`
